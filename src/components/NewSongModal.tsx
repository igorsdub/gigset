      ...
      <div className="bg-stage-card border border-stage-border rounded-xl w-full max-w-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden">
        ...
        <div className="p-4 border-b border-stage-border flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-lg text-stage-text">Add Song to Library</h3>
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-semibold text-stage-text mb-1">
                Title *
              </label>
              <input
                type="text"
                ...
                className="w-full bg-stage-hover border border-stage-border rounded-lg px-3 py-2 text-sm text-stage-text focus:outline-none focus:border-stage-accent"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold text-stage-text mb-1">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-stage-hover border border-stage-border rounded-lg px-3 py-2 text-sm text-stage-text font-mono focus:outline-none focus:border-stage-accent"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold text-stage-text mb-1">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="block text-xs font-semibold text-stage-text">
                Extended ChordPro Notation (with measure pipes '|')
              </label>
              <button
                type="button"
                onClick={insertSampleTemplate}
                className="text-[11px] text-stage-accent hover:opacity-80"
              >
            ...
            <textarea
              ...
              className="w-full bg-stage-hover border border-stage-border rounded-lg p-3 text-sm font-mono text-stage-text focus:outline-none focus:border-stage-accent leading-relaxed"
            />
            <p className="text-[11px] text-stage-muted mt-1">
              Tip: Enclose chords in brackets like <code className="text-stage-chord">[G]</code>. Use pipes <code className="text-stage-text">|</code> for measure boundaries to enable the iReal-style Chord Grid.
            </p>
          </div>
          ...
          <div className="flex justify-end gap-2 pt-2 border-t border-stage-border">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-xs font-medium text-stage-text rounded-lg bg-stage-hover hover:bg-stage-card transition-colors"
            >
              Cancel
            </button>
            <button
